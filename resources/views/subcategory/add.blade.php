                        ...
                        <div class="col-xl-6 box-col-6 col-md-6">
                                <div class="container-fluid">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{url('/store/sub-category')}}" method="post">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12 mb-3">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="SubCategory" value="{{old('sub_category')}}" name="sub_category" required>
                                                    </div>
                                                </div>
