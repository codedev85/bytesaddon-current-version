...
@section('admin-content')
    ...
    <div class="page-body">
        ...
        <div class="card text-center">
            <div class="card-header"><h2>Search Result(s) - {{($searchCount)}} Product(s) Listed </h2></div>
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    @foreach($searchItem as $key => $product)
                    <tr>
            ...
            <div class="card-footer text-muted">{{$searchItem->links()}}</div>
        </div>
